      ...
      try {
        ...
        setComments([
          ...
          },
          {
            ...
            content: 'Kết thúc thật bất ngờ! Không nghĩ là thủ phạm lại là người đó.',
        ...
        setReviews([
          {
            ...
            rating: 9,
            content: 'Một bộ phim xuất sắc với cốt truyện chặt chẽ và hình ảnh đẹp mắt.',
                ...
                <div className="mt-6">
                    ...
                    {activeTab === 'cast' && (
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                {cast.map((actor) => (
                                    <div key={actor.id} className="bg-gray-800 rounded-lg p-4 text-center">
                                        <Image
                                ...
                                <div className="flex justify-between items-center mt-3 pt-3 border-t border-gray-700">
                                    <span className="text-xs text-gray-500">
                                        <label class="inline-flex items-center cursor-pointer">
                                            ...
                                            <span class="ms-3 text-xs font-medium text-white">Tiết lộ?</span>
                                        </label>
                                    </span>
                                    <button
                                        type="submit"
                                    ...
                                    <div key={comment.id} className="bg-gray-800 rounded-lg p-4">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className={`text-sm text-gray-300 ${shouldHideSpoiler ? 'blur-sm' : ''}`}>
                                                    {comment.content}
                                                </p>
                                                {shouldHideSpoiler && (
                                                    <button
