    ...
    <section className="relative">
            ...
            <div className="relative h-full">
              ...
              <div className="absolute inset-0">
                <Image
                  ...
                  priority={index === 0}
                />
                <div className="absolute inset-0 bg-black/40 transition-opacity duration-800"></div>
              </div>

              {/* Content */}
              <div className="relative z-10 h-full flex items-center">
                <div className="container mx-auto px-4">
                  <div className="grid grid-cols-1 gap-8 items-center h-full py-16">
                    {/* Movie Info */}
      ...
      <style jsx>{`
        ...
        .movie-title-container {
          animation: slideInLeftTitle 1s ease-out 0.2s both;
        }
